CLASS zcl_rap100_gen_data_ln DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_ln IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'LN',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_ln.
    DELETE FROM zrap100_atrav_ln.

    "insert travel demo data
    INSERT zrap100_atrav_ln  FROM (
        SELECT

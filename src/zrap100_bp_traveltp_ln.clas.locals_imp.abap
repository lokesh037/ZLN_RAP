...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_LN,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav_LN FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtravLN FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setstatustoopen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_LN IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_LN IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_LN.
...
**************************************************************************
   DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_LN .
...
*************************************************************************************
  ...
  METHOD rejectTravel.
*************************************************************************************
* Instance-bound non-factory action: Set the overall travel status to 'x' (Reject)
*************************************************************************************
   " modify travel instance
   MODIFY ENTITIES OF zrap100_r_traveltp_LN IN LOCAL MODE
      ENTITY Travel
